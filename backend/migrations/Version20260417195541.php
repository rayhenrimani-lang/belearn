 ...
 */
final class Version20260417195541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cours CHANGE formateur_id formateur_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cours CHANGE formateur_id formateur_id INT NOT NULL');

...
try {
    ...
    $existingThemes = $entityManager->getRepository(Theme::class)->findAll();
    ...
    $theme1->setImageUrl('https://picsum.photos/300/200?random=1');
    ...
    $theme2->setImageUrl('https://picsum.photos/300/200?random=2');
    ...
    $theme3->setImageUrl('https://picsum.photos/300/200?random=3');

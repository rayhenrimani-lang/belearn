...
export function CoursesTabScreen() {
  ...
  return (
    <View style={[styles.screen, { paddingTop: insets.top + spacing.md }]}>
      <Text style={[typography.title, styles.title]}>Catalogue</Text>
      <Text style={styles.sub}>Tous les parcours disponibles</Text>
      <View style={styles.searchWrap}>
        <SearchBar value={query} onChangeText={setQuery} placeholder="Filtrer les cours…" />
      </View>
      ...
      {loading && courses.length === 0 ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={<Text style={styles.empty}>Aucun cours.</Text>}
        />
      )}
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  sub: { ...typography.subtitle, marginBottom: spacing.md },
